	...
	public ActionCard addCard(String aInstructions) {
		if (numberOfCards() >= maximumNumberOfCards()) {
			...
			switch (aInstructions) {
				case "Connect Tiles":
					return (new ConnectTilesActionCard(aInstructions, this));
				case "Lose Turn":
					return (new LoseTurnActionCard(aInstructions, this));
				case "Remove Tile":
					return (new RemoveConnectionActionCard(aInstructions, this));
				case "Teleport":
					return (new TeleportActionCard(aInstructions, this));	
				case "Roll Again":
					return (new RollDieActionCard(aInstructions, this));
				default:
					break;
			}
		}
